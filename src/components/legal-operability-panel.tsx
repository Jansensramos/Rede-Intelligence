...
export function LegalOperabilityPanel({ workspace }: { workspace: LegalWorkspaceView }) {
  ...
  return <section className="panel">
    <div className="panel-heading"><div><span className="eyebrow">OPERAÇÃO HUMANA · 10C.1</span><h2>Operações Jurídicas</h2><p>Abra diligências, registre decisões e controle a integração de obrigações com o Financeiro.</p></div><button className="button button-primary" disabled={pending} onClick={newDiligence}><FilePlus2 size={16}/> Nova diligência</button></div>
