...
const replacements: Array<[RegExp, string]> = [
  ...
  [/\bStudio\b/gi, "Relatórios"],
  [/\bFunding\b/gi, "Financiamento"],
  [/\bInsight(?:s)?\b/gi, "Análises"],
  [/\bDashboard\b/gi, "Painel"],
  [/\bWorkflow\b/gi, "Fluxo"],
  [/\bPipeline\b/gi, "Fluxo"],
  [/\bBacklog\b/gi, "Pendências"],
  [/\bBreak[- ]?even\b/gi, "Ponto de equilíbrio"],
  [/\bStress\b/gi, "Teste de resistência"],
  [/\bSnapshot\b/gi, "Versão registrada"],
  [/\bSnapshots\b/gi, "Versões registradas"],
  [/\bREDE Engine\b/gi, "Motor de Viabilidade REDE"],
  [/\bCovenants?\b/gi, "Cláusulas financeiras"],
  [/\bBaseline\b/gi, "Base de referência"],
  [/\bMarketplace\b/gi, "Mercado de oportunidades"],
  [/\bDead[- ]letter\b/gi, "Fila de falhas"],
  [/\bRelease\b/gi, "Versão"],
  [/\bBuild\b/gi, "Compilação"],
  [/\bMigrations?\b/gi, "Atualizações do banco"],
  [/\bDRAFT\b/g, "Rascunho"],
  [/\bSUBMITTED\b/g, "Enviada"],
  [/\bUNDER_REVIEW\b/g, "Em análise"],
  [/\bAPPROVED\b/g, "Aprovado"],
  [/\bREJECTED\b/g, "Rejeitado"],
  [/\bACTIVE\b/g, "Ativo"],
  [/\bINACTIVE\b/g, "Inativo"],
  [/\bOPEN\b/g, "Aberto"],
  [/\bCLOSED\b/g, "Fechado"],
  [/\bFINAL\b/g, "Finalizado"],
  [/\bFAILED\b/g, "Falhou"],
  [/\bSUCCEEDED\b/g, "Concluído"],
  [/\bCANCELLED\b/g, "Cancelado"],
  [/\bPENDING\b/g, "Pendente"],
  [/\bREAL_NOT_VERIFIED\b/g, "não verificado"],
  [/\bReady\b/g, "Pronto"],
