...
export function OperationsOperabilityPanel({ workspace, canWrite, canApprove }: { workspace: OperationsWorkspaceView; canWrite: boolean; canApprove: boolean }) {
  ...
  return <section className="panel">
    {!canWrite && !canApprove && <div className="model-note"><div><strong>Modo de leitura</strong><p>Seu perfil pode consultar base, orçamento e cronograma, mas não alterar nem aprovar registros.</p></div></div>}
